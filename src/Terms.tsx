      ...
      <div style={{
        ...
        <div style={{ lineHeight: '1.6', color: '#374151' }}>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <p style={{ marginTop: '1rem' }}>
              We use Firebase Authentication to manage user sessions and may store user profile information
              in Firebase Firestore for service functionality.
            </p>
          </section>

          <section style={{ marginBottom: '2rem' }}>
            <h2 style={{ color: '#1f2937', marginBottom: '1rem' }}>4. Acceptable Use and AI Service Integration</h2>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <p>
              Your privacy is important to us. Our service processes data through multiple third-party services:
            </p>
            <ul style={{ marginLeft: '1.5rem', marginTop: '0.5rem' }}>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <p style={{ marginTop: '1rem' }}>
              You can manage notification preferences through your device settings or our application settings.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <p>
              Salamander integrates with third-party services including Google Firebase and Anthropic Claude.
              Your use of these integrated services is subject to their respective terms of service and
              privacy policies. We are not responsible for the practices or content of these third-party services.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              through our official support channels or via the contact methods provided in the application.
            </p>
          </section>
        </div>
