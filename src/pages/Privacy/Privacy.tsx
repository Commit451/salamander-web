            ...
            <div style={{
                ...
                <div style={{lineHeight: '1.6', color: '#374151'}}>
                    <section style={{marginBottom: '2rem'}}>
                        ...
                        <h3 style={{color: '#374151', marginBottom: '0.5rem', marginTop: '1rem'}}>Account
                            Information</h3>
                        <p>
                    ...
                    <section style={{marginBottom: '2rem'}}>
                        ...
                        <ul style={{marginLeft: '1.5rem', marginTop: '0.5rem'}}>
                            <li><strong>Firebase Authentication:</strong> Manages your login sessions and account data
                            </li>
                            <li><strong>Firebase Firestore:</strong> Stores your application data and preferences</li>
                            <li><strong>Firebase Cloud Messaging:</strong> Handles push notifications to your devices
                            </li>
                            <li><strong>Firebase Analytics:</strong> Provides usage insights (anonymized when possible)
                            </li>
                        </ul>

                        <h3 style={{color: '#374151', marginBottom: '0.5rem', marginTop: '1rem'}}>Anthropic Claude</h3>
                        <p>
                            When you interact with AI features, your queries and commands are sent to Anthropic's Claude
                            API.
                        ...
                        <p>
                            Authentication is handled through Google's OAuth 2.0 system, subject to Google's privacy
                            policy.
